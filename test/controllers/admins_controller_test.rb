...
class AdminsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin" do
    assert_difference("Admin.count") do
      post admins_url, params: { admin: { employee_id: @admin.employee_id, name: @admin.name } }
    end
  ...
  test "should update admin" do
    patch admin_url(@admin), params: { admin: { employee_id: @admin.employee_id, name: @admin.name } }
